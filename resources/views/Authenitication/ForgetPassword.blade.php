                                    ...
                                    <div class="text-center">
                                     ...
                                     @csrf
                                        <div class="form-group">
                                            <input id="email" class="block mt-1 w-full form-control form-control-user" type="email" name="email" :value="old('email')" required autofocus
                                                placeholder="Enter Email Address...">
                                        </div>
                                         @error('email')
                                            <p class="text-danger">{{ $message }}</p>
                                         @enderror 
                                        <button class="btn btn-primary btn-user btn-block" type="submit"> {{ __('Email Password Reset Link') }}</button>
                                    </form>
                                    <hr>
                                    <div class="text-center">
